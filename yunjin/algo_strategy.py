...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def build_reinforced_defence(self, game_state):
        ...
        while self.SP(game_state) > 1 and limit > 0:
            ...
            side = defend[1]
            if space == 1:
                self.build_next_defence(game_state, first_turret[side])
            elif space == 2:
                self.build_next_defence(game_state, second_turret[side])
            else:
                self.build_next_defence(game_state, third_turret[side])
